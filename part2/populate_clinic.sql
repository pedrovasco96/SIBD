...
-- (name, description)
insert into species values ('canis familiaris', 'dog');
insert into species values ('bird', 'bird');
insert into species values ('cat', 'cat');

-- (name, name)
insert into generalization_species values ('Labrador', 'canis familiaris');
insert into generalization_species values ('Doberman', 'canis familiaris');
...
insert into animal values ('Pizzi', 2425, 'Doberman', 'black', 'M', 2010, 8);
insert into animal values ('Esferovite', 2425, 'Labrador', 'white', 'M', 2015, 3);
insert into animal values ('Bruno César', 88, 'Eagle', 'white', 'M', 2005, 13);
insert into animal values ('Amelie', 2426, 'cat', 'white', 'F', 2016, 2);
